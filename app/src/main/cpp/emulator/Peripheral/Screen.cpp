...
namespace casioemu
{
	...
	template <HardwareId> struct SpriteDef;

template <> struct SpriteDef<HW_CLASSWIZ_II> { enum Sprite : unsigned {
	SPR_PIXEL, SPR_S, SPR_MATH, SPR_D, SPR_R, SPR_G, SPR_FIX, SPR_SCI, SPR_E,
	SPR_CMPLX, SPR_ANGLE, SPR_WDOWN, SPR_VERIFY, SPR_LEFT, SPR_DOWN, SPR_UP,
	SPR_RIGHT, SPR_PAUSE, SPR_SUN, SPR_MAX
}; };

template <> struct SpriteDef<HW_CLASSWIZ> { enum Sprite : unsigned {
	SPR_PIXEL, SPR_S, SPR_A, SPR_M, SPR_STO, SPR_MATH, SPR_D, SPR_R, SPR_G,
	SPR_FIX, SPR_SCI, SPR_E, SPR_CMPLX, SPR_ANGLE, SPR_WDOWN, SPR_LEFT, SPR_DOWN,
	SPR_UP, SPR_RIGHT, SPR_PAUSE, SPR_SUN, SPR_MAX
}; };

template <> struct SpriteDef<HW_ES_PLUS> { enum Sprite : unsigned {
	SPR_PIXEL, SPR_S, SPR_A, SPR_M, SPR_STO, SPR_RCL, SPR_STAT, SPR_CMPLX,
	SPR_MAT, SPR_VCT, SPR_D, SPR_R, SPR_G, SPR_FIX, SPR_SCI, SPR_MATH,
	SPR_DOWN, SPR_UP, SPR_DISP, SPR_MAX
}; };
...
template <HardwareId hardware_id>
	class Screen : public Peripheral
	{
		...
		typedef typename SpriteDef<hardware_id>::Sprite Sprite;
		static const int SPR_MAX = Sprite::SPR_MAX;
